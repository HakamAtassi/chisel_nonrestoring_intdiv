...
```sh
git clone git@github.com:HakamAtassi/chisel_nonrestoring_intdiv.git
cd chisel_nonrestoring_intdiv
```
...
#### Commit your changes
```sh
git commit -m 'Starting chisel_nonrestoring_intdiv'
...
```sh
mill chisel_nonrestoring_intdiv.test
```
